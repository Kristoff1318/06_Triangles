...
def add_box( polygons, x, y, z, width, height, depth ):
    ...
    #botttom
    add_polygon(polygons, x, y1, z1, x1, y1, z, x, y1, z)
        ...
        for longt in range(longt_start, longt_stop):
            ...
            if (longt == longt_start):
                add_polygon(polygons, 
                    ...
                    points[index][1],
                    points[index][2],
                    points[(index+steps+1) % l][0],
                    points[(index+steps+1) % l][1],
                    points[(index+steps+1) % l][2],
                    points[(index+steps) % l][0],
                    points[(index+steps) % l][1],
                    points[(index+steps) % l][2] )
